    ...
    <div class="tab-content">
       ...
       <div class="tab-pane container fade" id="receivers">
         ...
         <form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
          ...
          <input type="text" name="rcity" placeholder="User City" class="form-control mb-3"  pattern = "Bangalore" required >
          <input type="tel" name="rphone" placeholder="User Phone Number" class="form-control mb-3"  pattern="[0,6-9]{1}[0-9]{9,11}" title="Password must have start with 789 and must have 10 digit" required>
          <input type="email" name="remail" placeholder="User Email" class="form-control mb-3" pattern = "^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$" reqired>
